CineScope – TV Show Discovery Web App

This project named "CineScope" helps users search and explore TV shows easily. The app fetches real TV show data from the TVMaze API and displays show information like ratings, genres, and release year. Users can also save their favorite shows and switch between dark and light mode.

Key Features
Search TV Shows: Users can search for TV shows using the search bar. The app fetches live data from the TVMaze API.

Favorites System: Users can add or remove favorite shows. Favorites are saved using localStorage, so data stays even after refreshing the page.

Search History: The app stores recent searches and allows users to quickly search again using history buttons.

Responsive Design: The website works properly on desktop, tablet, and mobile screens using responsive CSS grid and flexbox.

Dark / Light Mode: Users can switch between dark and light themes using the theme toggle button.

Show Information
Each TV show card displays:
-Show image
-Show name
-Rating
-Genres
